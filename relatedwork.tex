...
1-2). 
%{\tool} is also related to SQLook~\cite{icsm13}. However, 
...
%%Their slicing cannot work across embedded SQL code.

%In {\tool}, we apply the idea of using individual rows as test cases
%as in their method.
