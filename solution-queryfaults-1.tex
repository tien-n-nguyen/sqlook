...
25 AND Gender = `Female' OR Country $<>$ `USA'}. Our instrumented
...
\begin{figure*}[tbp]
  \centering
  \includegraphics[width=4.6in]{images/Instrumented-Code-2.eps}\\
...
(\code{FilteredRows}) are rows 2 and 3 of the \code{Users}
...
name \code{`u'} for the \code{Users} table). In such cases, \tool{}
