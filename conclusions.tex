...
%For single-fault scenarios, around 84\% of the seeded faults are
%correctly identified by {\tool} with a single recommendation. For
%multiple-fault scenarios, 60\% of the cases have their faults detected
%in the top-2 list.
